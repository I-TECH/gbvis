<?php 
  ...
  $page_title = "Update survey| GBV";
    $current_page = "Update survey";
...
if(isset($_POST['submit-form'])) { 
	...
	if($success)
	{
	    ...
	    $id = $db->update($data, "surveys","survey_id= $survey_id");
...
?>
	...
	<?php
	  ...
	  <div id="main-content_with_side_bar">
        ...
        <div id="content-body">
		<h3 class="page-title">Edit surveys</h3>
	       <hr size="1" color="#CCCCCC">
    <div class="profile-data" align="left">
	<?php echo ($msg != "") ? $msg : ""; ?>
	<br clear="all">
     <a href="survey_periods.php">Back to surveys</a>
