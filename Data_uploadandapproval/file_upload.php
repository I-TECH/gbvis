...
<tr>
<td width="50%" style="font:bold 12px tahoma, arial, sans-serif; text-align:right; border-bottom:1px solid #eee; padding:5px 10px 5px 0px; border-right:1px solid #eee;">Sector</td>
...
if($uploadExcel->UploadedStatus($_POST["submit"],$_FILES["file"]))
{
 ...
 echo "<script type='text/javascript'>alert('$fileName. already exists in Uploads folder.Please give the file a diffrerent name')</script>";
