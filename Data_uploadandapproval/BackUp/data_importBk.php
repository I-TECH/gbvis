...
echo "All data records imported succesfully";
else
{
//continue;
$html.="<tr><td colspan='5'>The following data Could not be inserted. Data of similar details have already exist</td></tr>";
