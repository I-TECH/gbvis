<?php
// TA:60:4
$page_title = "Procecution sector | GBV ";
$current_page = "home";
...
if( !($userTools->isAdmin($user->user_group) &&  $user->sector === '4')){
    ...
    $indicators = $db->selectAllOrderedWhere("indicators", "indicator", " sector_id=4");
    $ranks = $db->selectAllOrderedWhere("ranks", "rank", " sector_id=4");
			  ...
			  add_indicator17();
            	   ...
            	   if(validate("county", county_id) && validate("date", date)){
            		   ...
            		   var url= "";
        				  ...
        				  for(var $i=0; $i<$RANK_AMOUNT; $i++){
          					  ...
          					  var male_rank = $('#indicator15').find( "#male_rank" + $i ).val();
         					  var male_aggregate = $('#indicator15').find( "#male_aggregate" + $i ).val();
         					  if(male_rank != ''){
                        		if(validate("aggregate in Indicator 6.1 section", male_aggregate)){
                             		if(indicator15 != ""){
                             			indicator15 += ";";
                             		}
                             		indicator15 += "Male," + male_rank + "," + male_aggregate;
                         		}else{
                             		return;
                         		}
                      		}

        					  var female_rank = $('#indicator15').find( "#female_rank" + $i ).val();
        					  var female_aggregate = $('#indicator15').find( "#female_aggregate" + $i ).val();
        					  if(female_rank != ''){
                        		if(validate("aggregate in Indicator 6.1 section", female_aggregate)){
                             		if(indicator15 != ""){
                             			indicator15 += ";";
                             		}
                             		indicator15 += "Female," + female_rank + "," + female_aggregate;
                         		}else{
                             		return;
                         		}
                     		}
        				  ...
        				  if(indicator15 != ""){
        					  url += "&indicator15=" + indicator15;
        				  }

        				  var other_indicators = ["16", "17"];
               ...
               function add_indicator15(){
            	   var text = "";
            		  ...
            		  $("#indicator15").html(text);  
               }

               function add_indicator16(){
            		  $("#indicator16").html("<input type='text' onkeypress='return isNumberKey(event)' id='aggregate16' name='aggregate16' placeholder='Aggregate' class='gbvis_smallBoxInputs' title='Aggregate'>");  
        		  }

               function add_indicator17(){
          		  $("#indicator17").html("<input type='text' onkeypress='return isNumberKey(event)' id='aggregate17' name='aggregate17' placeholder='Aggregate' class='gbvis_smallBoxInputs' title='Aggregate'>");  
      		  }
...
<div id="main-content_with_side_bar">
	...
	<div id="content-body">
		...
		<div class="profile-data" align="left">
			...
			<h2 class="page-title-section">Prosecution sector data entry</h2>
  ...
  <?php
    ...
    ?>
                ...
                <tr><td>
                 <b>Indicator 6.1 Number of prosecutors who have been trained in SGBV using SGBV prosecutor's manual</b><br><div id='indicator15'></div> <script type='text/javascript'>add_indicator15();</script><br>
                 <b>Indicator 6.2.a Number of SGBV cases that were prosecuted during the specified time period</b><br><div id='indicator17'></div> <script type='text/javascript'>add_indicator17();</script><br>
                <b>Indicator 6.2.b Total number of SGBV cases reported to the police in the same time period</b><br><div id='indicator16'></div> <script type='text/javascript'>add_indicator16();</script><br>
                 </td></tr>
