...
<div class="sidebar-nav">
	<?php
     ...
     $page = (int)(!isset($_GET["page"]) ? 1 : $_GET["page"]);
       ...
       $statement = "`indicators` WHERE sector_id=$user_sector_name"; // Change `records` according to your table name.
    ...
    ?>
              <tr bgcolor="#FFFFFF" style="border-bottom: 1px solid #B4B5B0;">
				...
				<td><?php echo $date ?></td>
                  <td align="center"><a href='view_indicator.php?id=<?php echo $id;?>'><img src="images/icons/view2.png" height="20px"/><a></td>	       
		<td align="center"><a href='edit_indicator.php?id=<?php echo $id;?>'><img src="images/icons/edit2.png" height="20px"/></a></td>
          </tr>
            <?php
            }
            } 
