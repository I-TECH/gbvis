...
***********************************************************************/
//users_accounts.php
  $page_title = "Police indicators| GBV";
    $current_page = "Police indicators";
...
<div class="sidebar-nav">
	<?php
     ...
     $page = (int)(!isset($_GET["page"]) ? 1 : $_GET["page"]);
       ...
       $statement = "`prosecution_aggregates` ORDER BY `id` ASC"; // Change `records` according to your table name.
