...
?>
	...
	<?php
	  ...
	  <div id="main-content">
        ...
        <div id="content-body">
		<h3 class="page-title">Edit Indicator</h3>
...
<tr>
<td colspan="2" style="font:bold 21px arial; text-align:center; border-bottom:1px solid #eee; padding:5px 0 10px 0;">Edit indicator</td></tr>
</tr>
<tr>
...
<td width="50%" class="table-td-input"><div id='s3'><div id='t1'><textarea type=text name=indicator style="height:140px; width:230px;"  class=form_textbox_inputs><?php echo $indicator ?> </textarea></div></td>
</tr>
<tr>
