...
//     var img = document.createElement('IMG');
 //    img.setAttribute('src', '../../UI/images/data_loading_animation.gif');
...
<div id="main-content">
	...
	<div id="content-body">
		...
		<div class="profile-data" align="left">
			...
			<h2 class="page-title-section">Judiciary sector import excel</h2>
			...
			<table width="900px" border="0" cellspacing="5"
				...
				<tr>
					<td>
					Instruction:<br>
					1. Download Excel template <a href="files/Judiciary sector data entry sheet.xlsx">here</a><br>
