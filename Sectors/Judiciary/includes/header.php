...
<link href="../../UI/ss/popupcss.css" rel="stylesheet" type="text/css">
...
<script language="javascript" src="./js/judiciary.js"></script>
   ...
   <div class="logo">
    ...
    <div class="menuLinks">
	  ...
	  <div class="user_status_nav">
		...
		<font style="font-family:Verdana, Geneva, sans-serif; font-size:15px; color:white;padding-right:2px;"> Welcome <?php echo $Logged_user ?></font>|
