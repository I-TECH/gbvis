...
function getFormData(myForm2) { 
var myParameters = new Array(); 
//// Text field data collection //
var val=myForm2.aggregates.value;
val = "aggregates="+val;
...
var val=myForm2.county.options[myForm2.county.options.selectedIndex].value;
val = "county="+val;
myParameters.push(val);

var val=myForm2.survey.options[myForm2.survey.options.selectedIndex].value;
val = "survey="+val;
myParameters.push(val);

var val=myForm2.indicator.options[myForm2.indicator.options.selectedIndex].value;
val = "indicator="+val;
myParameters.push(val);
...
var url="update_aggregates.php";
var myForm2 = document.forms[0]; 

var parameters=getFormData(myForm2);
