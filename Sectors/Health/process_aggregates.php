...
$row=array("s1"=>"T","s2"=>"T","s3"=>"T","s4"=>"T","t1"=>"T","msg"=>"","status_form"=>"OK");
...
$sql = "insert into health_aggregates set county_id='".$county."', survey_id='".$survey."',indicator_id='".$indicator."',gender='".$gender."',aggregate='".$aggregates."'";
$sql = @mysql_query($sql);
...
if(!$sql)
{
    $msg .= "Data Of simlar Details(Indicator,Survey Period,County,gender) Already exist";
}
