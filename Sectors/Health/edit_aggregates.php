...
$aggr_results = $db->selectData("health_aggregates"," id = $aggregate_id");
...
$age_results = $db->selectData("age_range"," age_range_id = $age");
foreach ($age_results as $arows) 
{
  $age_id = $arows['age_range_id'];
   $age = $srows['age_range'];
}
...
?>
 ...
 <table class="forms-table" width="700" style="">
  <form  name="myForm" method="post" action="update_aggregates.php" >
...
<tr>
<td colspan="2" style="font:bold 21px arial; text-align:center; border-bottom:1px solid #eee; padding:5px 0 10px 0;"><p id="msgDsp" STYLE="color:#FF0000; font-size:14px; ">
...
<td width="50%" class="table-td-input"><div id='s1'><input type=text name=aggregate_id value="<?php echo $aggregate_id ?>" readonly class=form_textbox_inputs></div></td>
</tr>
</tr>
<tr>
...
<td width="50%" class="table-td-input"><div id='s3'><div id='t1'><input type=text name=indicator value="<?php echo $age ?>"  readonly class=form_textbox_inputs></div></td>
</tr>
<tr>
<td width="50%" class="table-td-input">Gender</td>

<td width="50%" class="table-td-input"><div id='s3'><div id='t1'><input type=text name=indicator value="<?php echo $gender?>"  readonly class=form_textbox_inputs></div></td>
</tr>
<tr>
