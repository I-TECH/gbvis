...
$reportName = "Judiciary Report";
$reportNameYPos = 160;
$logoFile = "negc_logo.jpg";
$logoXPos = 50;
$logoYPos = 108;
$logoWidth = 110;
$columnLabels = array( "CM1", "CM2", "CM3");
$rowLabels = array( "Tally of judges trained", "Proportion of withdrawn cases", "Proportion of convicted  cases");
$chartXPos = 20;
$chartYPos = 250;
$chartWidth = 160;
$chartHeight = 80;
$chartXLabel = "SGBV indicator";
$chartYLabel = "SGBV indicator";
$chartYStep = 20000;
...
$result = $conn->fetchrow('SELECT * from judiciary');
...
// Logo
$pdf->Image( $logoFile, $logoXPos, $logoYPos, $logoWidth,0,'JPG' );
...
$pdf->Cell( 80, 12, "INDICATOR", 1, 0, 'L', true );
...
for ( $i=0; $i<count($columnLabels); $i++ ) {
  $pdf->Cell( 20, 12, $columnLabels[$i], 1, 0, 'C', true );
}
...
foreach ( $data as $dataRow ) {
  ...
  for ( $i=0; $i<count($columnLabels); $i++ ) {
    $pdf->Cell( 20, 12, (  number_format( $dataRow[$i] ) . '%' ), 1, 0, 'C', $fill );
  }
