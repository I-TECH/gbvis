...
<script src="../../../UI/jsjquery-ui-1.11.2.custom//jquery-ui.js"></script>
 <link rel="stylesheet" type="text/css" href="../../../UI/css/datepicker/datepickr.min.css">
 <link rel="stylesheet" type="text/css" href="../../../UI/css/datepicker/datepickr.css">
 <script src="../../../UI/css/datepicker/datepickr.css"></script>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'Total SGBV Prosecuted  cases  2015.'
                },
                subtitle: {
   ...
   <div class="logo">
    ...
    <div class="menuLinks">
	  ...
	  <div class="user_status_nav">
		...
		<font style="font-family:Verdana, Geneva, sans-serif; font-size:15px; color:white;padding-right:2px;"> <?php echo $Logged_group; ?></font>|
		<font style="font-family:Verdana, Geneva, sans-serif; font-size:15px; color:white;padding-right:2px;"> <?php echo $user_sector; ?></font>|
