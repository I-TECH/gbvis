...
$result = $conn->fetch('SELECT * from indicators');
...
$data['indicators_name']=$piedata["indicators"];
$data['county']=$piedata["county"];
$data['tally']=$piedata["tally"];
...
$valX = $pdf->GetX();
$valY = $pdf->GetY();
$pdf->Cell(40, 5, 'Indicator');
$pdf->Cell(15, 5, $data['indicator_name'], 0, 0, 'R');
$pdf->Ln();
$pdf->Cell(42, 5, 'County');
$pdf->Cell(15, 5, $data['County'], 0, 0, 'R');
$pdf->Ln();
$pdf->Cell(42, 5, 'Aggreagtes:');
$pdf->Cell(15, 5, $data['tally'], 0, 0, 'R');
$pdf->Ln();
$pdf->Ln(8);
