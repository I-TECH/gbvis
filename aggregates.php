...
***********************************************************************/
//users_accounts.php
  $page_title = "Judiciary indicators| GBV";
    $current_page = "Judiciary indicators";
...
<div class="sidebar-nav">
	<?php
     ...
     $page = (int)(!isset($_GET["page"]) ? 1 : $_GET["page"]);
       ...
       $statement = "`judiciary_aggregates` ORDER BY `id` ASC"; // Change `records` according to your table name.
    ...
    ?>
              <tr bgcolor="#FFFFFF" style="border-bottom: 1px solid #B4B5B0;">
				...
				<!--<td><?php echo $date; ?></td>-->
                 <td align="center"><a href='view_aggregates.php?id=<?php echo $id;?>'><img src="UI/images/icons/view2.png" height="20px"/><a></td>	       
		  </tr>
            <?php
            }
            } 
