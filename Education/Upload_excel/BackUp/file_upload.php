...
<td width="50%" style="border-bottom:1px solid #eee; padding:5px;"><textarea type="text" name="description" id="file"></textarea></td>
...
<td width="50%" style=" padding:5px;"><input type="submit" name="submit" value="upload"/></td>
...
echo '<tr><td><center><b><a href="import_data?filename='.$uploadExcel->fileName.'">Import Uploaded file</a> </b></center></td></tr></table>';
