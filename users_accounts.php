...
<div class="sidebar-nav">
    ...
    ?>
              <tr bgcolor="#FFFFFF" style="border-bottom: 1px solid #B4B5B0;">
				...
				<td><?php echo $date ?></td>
                               <td align="center"><a href='view_user.php?id=<?php echo $id;?>'><img src="UI/images/icons/view2.png" height="20px"/><a></td>
			       <td align="center"><a href='edit_user.php?id=<?php echo $id;?>'><img src="UI/images/icons/edit2.png" height="20px"/></a></td>
