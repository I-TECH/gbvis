...
<div class="sidebar-nav">
	<?php
	  ...
	  <div id="main-content">
		...
		<section class="" style="width:85%;">
          ...
          <input type="text" name="search" value="" id="id_search" placeholder="Filter records here" autofocus />
           <a class="link-btn" href="add_sector.php">New Sector</a>
          <a class="link-btn" href="export_sectorCsv.php">Export to csv</a>
           <a class="link-btn" href="export_sectorsExcel.php">Export to excel</a>
        ...
        <div class="profile-data" align="left">
          ...
          if (isset($_GET['id'])) {
            $query = "DELETE FROM sectors WHERE sector_id= '$_GET[id]'";
     ...
     $page = (int)(!isset($_GET["page"]) ? 1 : $_GET["page"]);
       ...
       $statement = "`sectors` ORDER BY `sector_id` ASC"; // Change `records` according to your table name.
    ...
    ?>
              <tr bgcolor="#FFFFFF" style="border-bottom: 1px solid #B4B5B0;">
                 ...
                 <td align="center"><a href='view_sector.php?id=<?php echo $id;?>'><img src="UI/images/icons/view2.png" height="20px"/><a></td>	       
		<td align="center"><a href='edit_sector.php?id=<?php echo $id;?>'><img src="UI/images/icons/edit2.png" height="20px"/></a></td>
    ...
    <script>
      function show_confirm(id) {
        if (confirm("Are you Sure you want to delete?")) {
          location.replace('sectors.php?id=' + id);
        } else {
          return false;
        }
      }
