...
?>
	...
	<?php
	  ...
	  <div id="main-content_with_side_bar">
        ...
        <div id="content-body">
		<h3 class="page-title">View survey</h3>
	       <hr size="1" color="#CCCCCC">
    <div class="profile-data" align="left">
	<?php echo ($msg != "") ? $msg : ""; ?>
	      
 <table class="forms-table" width="700" style="">
  <form  name="myForm" action="update_surveyperiod.php">
...
<td width="50%" class="table-td-input"><div id='t1'><input type=text name="survey_name" value="<?php echo $survey_name ?>"  class=form_textbox_inputs></div></td>
</tr>
<tr>
