...
<!-- Below is how you can perform your users access level activities -->
      ...
      if($userTools->isGuest($user->user_group)) //Show only the logout link to users whose Access Level is at is guest
      {
     ...
     else if($userTools->isSuperAdmin($user->user_group)) //Show  enter admin panel to users whose Access Level is at super admin
     {
	?>
	<br clear="all">
