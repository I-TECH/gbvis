   ...
   <div class="logo">
    ...
    <div class="menuLinks">
	  ...
	  <div class="user_status_nav">
		...
		<a href="register.php" align="left" style="font-family:Verdana, Geneva, sans-serif; font-size:12px; color:white; text-decoration:none;padding-right:2px;padding-left:2px;">Create Account</a>
