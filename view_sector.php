...
<td width="50%" class="table-td-input"><div id='t1'><input type=text name=sector value="<?php echo $sector_name ?>" readonly class=form_textbox_inputs></div></td>
</tr>
<tr>
<td class="table-td-label"></td>

<td width="50%" style=" padding:5px;"> <a href="sectors.php">Back to Sectors</a></td>
</tr>
</form>
</table>
<br clear="all">
