<?php 
//index.php
  $page_title = "Add Survey | GBV";
    $current_page = "Add Survey";
...
?>
	...
	<?php
	  ...
	  <div id="main-content_with_side_bar">
        ...
        <div id="content-body">
	<h3 class="page-title">Add survey</h3>
...
<tr>
<td colspan="2" style="font:bold 21px arial; text-align:center; border-bottom:1px solid #eee; padding:5px 0 10px 0;">Add Survey periods</td></tr>
</tr>
<tr>
<td wwidth="50%" colspan="2" class="table-td-label"><center>survey</center></td></tr>
<tr>
<td width="50%" class="table-td-label">survey</td>
<td width="50%" class="table-td-input"><textarea type="text" name="survey" id="survey" style="height:50px;" class="form_textbox_inputs"></textarea></td>
</tr>
<tr>
